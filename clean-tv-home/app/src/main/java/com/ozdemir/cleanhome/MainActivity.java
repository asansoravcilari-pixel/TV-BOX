...
public class MainActivity extends Activity {
    ...
    private void buildHome() {
        ...
        sub.setTextColor(Color.rgb(130,145,165));
        sub.setTextSize(15);
        sub.setPadding(dp(3), dp(13), 0, 0);
        ...
        root.addView(lowerSpace, new LinearLayout.LayoutParams(1, 0, 1.15f));
    ...
    private GradientDrawable cardDrawable(boolean focused, int radius) {
        GradientDrawable d = new GradientDrawable(GradientDrawable.Orientation.TL_BR,
                focused ? new int[]{Color.rgb(48,64,86), Color.rgb(37,49,68)}
                        : new int[]{Color.rgb(28,37,51), Color.rgb(20,28,40)});
        d.setCornerRadius(radius);
        d.setStroke(dp(focused ? 2 : 1), focused ? Color.WHITE : Color.rgb(55,69,88));
        return d;
    }
